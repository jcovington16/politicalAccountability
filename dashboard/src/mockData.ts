...
export const securityControls: SecurityControl[] = [
  ...
  },
  {
    ...
    evidence: 'Append-only audit_log schema, repository, and read endpoint are now in place.',
    nextAction: 'Add auth middleware before exposing audit views outside local/admin use.',
  },
  {
    id: 'abuse',
